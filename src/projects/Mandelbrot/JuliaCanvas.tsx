...
export default function JuliaCanvas({innerRef, uniforms, collapse}:{innerRef:React.RefObject<HTMLCanvasElement | null>, uniforms:glUtils.UniformRefObject, collapse:string}){
    ...
    useEffect(()=>{
        ...
        const fragmentShaderSources = {
            renderShaderSource:"mandelbrot/juliaFragmentShader.glsl"
        }
